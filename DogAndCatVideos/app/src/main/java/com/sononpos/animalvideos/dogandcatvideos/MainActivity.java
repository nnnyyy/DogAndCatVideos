package com.sononpos.animalvideos.dogandcatvideos;
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind.btnSignout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Firebase sign out
                mAuth.signOut();
                LogHelper.di("firebase signout");
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        LogHelper.di("firebaseAuthWithGoogle:" + acct.getId());
    ...
    private void updateUI(FirebaseUser user) {
        if(user != null) {
            mBind.btnSignin.setVisibility(View.GONE);
            mBind.btnSignout.setVisibility(View.VISIBLE);
        }
        else {
            mBind.btnSignin.setVisibility(View.VISIBLE);
            mBind.btnSignout.setVisibility(View.GONE);
        }
    }
